...
class Sentence():
    ...
    def mark_safe(self, cell):
        ...
        """
        #更新原有知识，例如原有为知识{A,B，C}=3，但是现在已经知道B是安全的，那么原有知识被更新为{A,C}=2
        if cell in self.cells:
            self.cells.discard(cell)
...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        已知给定的安全单元cell，有count个相邻单元中有地雷：
             ...
             4，将任何额外的单元格标记为安全或地雷
                如果可以根据人工智能的知识库得出结论
             5，如果可以推理出新知识，将得到的新句子添加到 AI 的知识库中
        """
        #标记为已移动
    ...
    def make_random_move(self):
        ...
        """
        在没有一定安全的单元格时调用，从还没确定身份的单元格随机选择一个
        """
